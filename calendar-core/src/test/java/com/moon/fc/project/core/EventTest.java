...
public class EventTest {
    ...
    void test1() {
        ...
        Assertions.assertFalse(event.isOverlapped(testStartAt1, testEndAt1));
        Assertions.assertTrue(event.isOverlapped(testStartAt2, testEndAt2));
        Assertions.assertTrue(event.isOverlapped(testStartAt3, testEndAt3));
        Assertions.assertFalse(event.isOverlapped(testStartAt4, testEndAt4));
        Assertions.assertTrue(event.isOverlapped(testStartAt5, testEndAt5));
        Assertions.assertTrue(event.isOverlapped(testStartAt6, testEndAt6));
    }
